...
export default function App() {
  ...
  const handleWhatsAppAction = (customMsg = "") => {
    ...
    window.open(whatsappBaseUrl + "?text=" + encodeURIComponent(text), '_blank');
  };
        ...
        {isMenuOpen && (
          ...
          >
            ...
            <div className="mt-20 flex gap-8">
               ...
               <button onClick={() => handleWhatsAppAction()} className="text-[#D4AF37] font-bold tracking-widest text-xs uppercase text-left">WhatsApp</button>
            </div>
          </motion.div>
        )}
      </AnimatePresence>
