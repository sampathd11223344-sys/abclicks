...
// Removed @import from here to prevent decorator syntax errors
const CSS_STYLES = `
  body { 
...
export default function App() {
  ...
  useEffect(() => {
    // 1. Inject Fonts via Link Tag (Prevents @import parser errors)
  ...
  return (
    <div className="bg-black text-white font-sans selection:bg-[#D4AF37] selection:text-black min-h-screen overflow-x-hidden">
      ...
      <footer className="py-24 px-8 md:px-16 border-t border-white/5 text-center">
        ...
        <p className="text-[10px] tracking-widest text-zinc-800 uppercase font-black">© {new Date().getFullYear()} AB CLICKS STUDIO.</p>
      </footer>
